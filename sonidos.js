// sonidos.js v3 — risas, llantos, fiesta, desbloqueo y mayordomo
const AresSonidos = {
  c: null,
  ctx: () => {
  ...
  init: () => {
    ...
    const desbloq = () => { AresSonidos.ctx(); document.removeEventListener('click', desbloq); document.removeEventListener('touchstart', desbloq); };
    document.addEventListener('click', desbloq);
    document.addEventListener('touchstart', desbloq);
